<?php
/**
 * This page generates a form to subscribe
 *
 * @return string
 */
function subscribe() {
  ...
  return theme('subscribe', array('original_end_date'=>$original_end_date, 'extend_new_end_date'=>$extend_new_end_date,'subscribed' => in_array(helper::ROLE_HUISARTS_PLUS, array_values($user->roles))));
}
