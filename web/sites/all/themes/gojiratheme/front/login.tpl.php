<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4 frontpage_block form-block login">
            <div>
                <a class="register gbutton rounded noshadow left gbutton_widest" title="<?php echo t('Register'); ?>" href="/registreer" id="splash_register"><span><?php echo t('Register a new account'); ?></span></a>
