        ...
        <div class="col-sm-8 frontpage_block text">
            <div>
                ...
                <?php if (variable_get('gojira_subscribe_possible')): ?>
                    <p><a class="register gbutton rounded noshadow left gbutton_widest" title="<?php echo t('Register'); ?>" href="/registreer?ha=web" id="splash_register"><span><?php echo t('Register a new account'); ?></span></a></p>
                <?php endif; ?>
            </div>
        </div>
