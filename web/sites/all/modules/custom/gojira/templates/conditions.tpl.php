<div id="conditions_holder">
    ...
    <p><i><?php echo t('You need to agree to the terms & conditions to start to work with the system.'); ?></i></p>
    <?php endif; ?>

    <h1>Algemene voorwaarden Blijnder</h1>
    ...
    <p>Blijnder behoudt het recht haar software applicatie regelmatig en, geheel naar eigen inzicht, te wijzigen. Daarnaast behoudt Blijnder het recht voor om de wijze waarop de service wordt aangeboden en geëxploiteerd te wijzigingen.</p>
